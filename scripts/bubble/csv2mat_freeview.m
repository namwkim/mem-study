function bubble = csv2mat_freeview(img_path, clickfile, outfile)
%CSV2MATLAB Summary of this function goes here
%   e.g., csv2matlab('./preprop/click24_nov.csv', './datasets/bubble24_nov.mat', 
...
for i=1:imgCnt
    ...
    % set filenames
    s = struct('filename', img, 'impath', strcat(img_path,img), 'userdata',[]);
