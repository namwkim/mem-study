...
HIT_URL = "https://study.namwkim.org/socialdoi/treatment"  # Provide the URL that you want workers to sent sent to complete you task
...
REWARD = 0.75  # Base payment value for completing the task (in dollars)
...
DESCRIPTION = ("In this HIT you will be presented with a tree visualization of a government budget, and asked to find three budget programs as fast as possible. This HIT should take about 5 ~ 10 minutes to complete.")
